...
/* ------- g17p-astedit-auto-bind-event-by-decorator-@action ------- */
(() => {
    // ------- g17p-astedit-auto-bind-event-by-decorator-@action start
    const bus = require("@gotoeasy/bus");
    const postobject = require("@gotoeasy/postobject");
    const Err = require("@gotoeasy/err");
    ...
    bus.on(
        ...
        (function() {
            ...
            return postobject.plugin("g17p-astedit-auto-bind-event-by-decorator-@action", function(root, context) {
    ...
    // ------- g17p-astedit-auto-bind-event-by-decorator-@action end
})();

/* ------- g21p-astedit-attribute-transform-@merge ------- */
(() => {
    // ------- g21p-astedit-attribute-transform-@merge start
    const bus = require("@gotoeasy/bus");
    const postobject = require("@gotoeasy/postobject");
    const Err = require("@gotoeasy/err");
    ...
    bus.on(
        ...
        (function() {
            ...
            return postobject.plugin("g21p-astedit-attribute-transform-@merge", function(root, context) {
                root.walk("Tag", (node, object) => {
                    if (!node.nodes || !node.nodes.length) return; // 节点没有定义属性，跳过
    ...
    // ------- g21p-astedit-attribute-transform-@merge end
})();
        ...
        (function() {
            return postobject.plugin("y75p-page-gen-js-browserify-minformat", function(root, context) {
                ...
                context.result.browserifyJs = new Promise((resolve, reject) => {
                    ...
                    csjs.browserify(context.result.babelJs, null, [pathProjectNode_modules])
                        .then(js => {
